...
public class Elder extends MidEntity implements Agent {
	...
	private HashMap<Point, Elder> nearbyVillagers;
	private HashMap<Point, Agent> nearbyAgents;
	

	public Elder(Point p, int age) {
...
//			profession.update(time);
	 ...
	 */
	private void maybeSocialise(HashMap<Point, Elder> villagers) {
...
//				System.out.println("Creating ExplorePlan");
	...
	public Elder copy() {
		...
		Elder copy = new Elder(new Point(x,y),age);
		return copy;
//		throw new org.newdawn.slick.util.OperationNotSupportedException("what is a human mind?");
	...
	public HashMap<Point, Elder> getNearbyVillagers(){
